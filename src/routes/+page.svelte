...
<div class="main">
    ...
    <div class="sect experience" style="--gradient-to: {color}">
        ...
        <p>
            Working with multi-omic and genetic sequence data to find associations in the genome.
            More to come!
        </p>
    ...
    <div id="projects" class="sect proj" style="--gradient-to: {color}">
        ...
        <h2>Soundbits</h2>
        <p>
            Architected, designed and built a social media application that allows users to share
            and send "bits" of sound that they come across in their daily life, and enable other
            uses to use them as a library of samples for them to use in their music productions.
        </p>
        <h2>FIRST Robotics Match Optimizer</h2>
        <p>
            Built matchup optimizer utilizing Random Forest Classifiers and data pulled from
            official FIRST APIs to train a Random Forest Classifier alongside Binary Classification
            to predict wins to about an 85% accuracy rate. Included a Svelte frontend and
            visualization to inform match strategy.
        </p>
        <h2>roundify</h2>
        <p>
            Customized user interface for Firefox (via userchrome.css), includes integration that
            modifies the default homepage with the daily Astronomy Picture of the Day.
        </p>
        <h2>mtxmathtools</h2>
        <p>
            CLI matrix computational tool I wrote to make doing linear algebra homework easier.
            Wrapped in a python package.
        </p>
    </div>
    <Footer />
</div>
